...
interface PostRepository {
    ...
    suspend fun createPost(uuid: String, title: String?, text: String, parseMode: ParseMode)
    suspend fun editPost(postId: Int, title: String?, text: String, parseMode: ParseMode)
